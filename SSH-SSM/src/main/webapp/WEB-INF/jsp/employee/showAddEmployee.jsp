...
<body>
	...
	<table width="100%" height="90%" border="0" cellpadding="5"
		...
		<tr valign="top">
			<td>
				<form action="${pageContext.request.contextPath}/insertOneEmp" id="employeeForm" method="post">
					<!-- 隐藏表单，flag表示添加标记 -->
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
								...
								<table>
									<tr>
										...
										<td class="font3 fftd">身份证号码：<input type="text"
											name="idCardNum" id="cardId" size="20" /></td>
									</tr>
									<tr>
										<td class="font3 fftd">性别： <select name="gender"
											style="width: 143px;">
										...
										<select name="staff.staffId" style="width: 143px;" id="job_jId">
						...
						<tr>
							<td class="font3 fftd">政治面貌： 
								<select name="politics"style="width: 143px;">
									<option value="0">--请选择身份--</option>
									<option value="CROWD">群众</option>
									<option value="PPMEMBER">预备党员</option>
									<option value="PMEMBER">党员</option>
								</select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="font3 fftd">备&nbsp;&nbsp;&nbsp;&nbsp;注：<input
								...
								name="dept.dId" style="width: 100px;" id="dept_dId">
