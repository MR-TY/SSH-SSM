...
public class EmployeeController {
	...
	* 2018年1月3日       water           v1.0.0               修改原因
	...
	public String queryAllDept(Model model) throws Exception {
		...
		System.out.println("进到部门查询了---------"+employees);
	...
	public String addOneDept(Employee employee) throws Exception {
		System.out.println("进到员工添加了-----------------"+employee);
	...
	public String findEmployLike(String dId, String gender,String eName,Model model) throws Exception {
		System.out.println("dId:"+dId+"---"+"staffId:"+"gender:"+gender+"ename:"+eName);
		int dId1 = Integer.parseInt(dId);
		int genderId = Integer.parseInt(gender);
		Gender gender2 = Gender.values()[genderId];
		List<Employee> employees = employeeService.findEmployeeByMany(dId1,genderId,eName);
		model.addAttribute("emp", employees);
		return "/WEB-INF/jsp/employee/employee.jsp";
	}
}
